...
const baseMarkers = [
  ...
  { x: 0.659, y: 0.271,img: photo('2.jpg'),  title: 'Мое увлечение общением, не дало тебе съездить сюда. Я просто забыла об этом твоем желании. Прости. Надеюсь, мы это исправим в ближайшее время' },
  ...
  { x: 0.220, y: 0.420,img: photo('9.jpg'),  title: 'А помнишь куда выходили окна?) Наша машинка Лавочка Вечерние выходы с сигаретой в места для курения' },
