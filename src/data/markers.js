/**
 * Маркеры на карте воспоминаний.
 * Картинки теперь лежат в /public/photos/, поэтому путь строим через helper `photo()`
 * — файл src/utils/assetPath.js должен уже существовать.
 */
...
export const MARKERS = [
  ...
  },
  {
    ...
    caption: 'Металл по рельсам, как сердце по рёбрам.'
  },
  {
    x: 0.83,
    y: 0.46,
