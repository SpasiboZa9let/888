...
export const MARKERS = [
  ...
  { x: 0.659, y: 0.271, img: photo('2.jpg'),  title: 'Моё увлечение общением, не дало тебе съездить сюда. Прости. Надеюсь, мы это исправим в ближайшее время' },
  { x: 0.780, y: 0.420, img: photo('3.jpg'),  title: 'Ездили в "Шашлычный дворик"' },
  { x: 0.780, y: 0.580, img: photo('4.jpg'),  title: 'Пили кофе' },
  { x: 0.659, y: 0.729, img: photo('5.jpg'),  title: 'Наблюдали за реставрацией парка. И ты искусно совершал манёвры, чтобы припарковаться и выехать' },
  ...
  { x: 0.341, y: 0.271, img: photo('10.jpg'), title: 'Это был самый вкусный шашлык в моей жизни, потому что он был из твоих рук' },
